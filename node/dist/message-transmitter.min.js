...
"use strict";
/*!******************************************!*\
  !*** ./public/js/message-transmitter.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
...
class MessageTransmitter {
  ...
  async sendMessage() {
    ...
    await axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/message-api", {
      data: {
        message: this.sendTextValue
      }
    }).then(res => {
  ...
  async receiveMessage() {
    await axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/message-api").then(res => {
  ...
  async clearReceiveMessage() {
    await axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("/api/message-api").then(res => {
      this.receiveText.innerHTML = "";
    }).catch(err => {
      console.error(err);
    });
