...
class Account {
  ...
  async login() {
    this.getData();
    await axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/user-api/login", {
      data: {
  ...
  async signup() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/user-api/signup", {
      data: {
        username: this.username,
        password: this.password
      }
