...
/* harmony import */ var _theme_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./theme.js */ "./public/js/theme.js");


// Theme

(0,_theme_js__WEBPACK_IMPORTED_MODULE_1__.initializeTheme)();
class Account {
  constructor() {
  ...
  async login() {
    this.getData();
    try {
      let res = await axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/user-api/login", {
        data: {
  ...
  async signup() {
    ...
    try {
      let res = await axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/user-api/signup", {
        data: {
          username: this.username,
          password: this.password
        }
