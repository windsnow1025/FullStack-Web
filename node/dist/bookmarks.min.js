...
class Bookmarks {
  ...
  filterBookmarks() {
    ...
    const filteredBookmarks = this.bookmarks.filter(bookmark => {
      ...
      return (searchTerm === '' || bookmark.first_title.toLowerCase().includes(searchTerm) || bookmark.second_title.toLowerCase().includes(searchTerm) || bookmark.url.toLowerCase().includes(searchTerm) || bookmark.comment.toLowerCase().includes(searchTerm)) && (firstTitleTerm === '' || bookmark.first_title.toLowerCase().includes(firstTitleTerm)) && (secondTitleTerm === '' || bookmark.second_title.toLowerCase().includes(secondTitleTerm)) && (urlTerm === '' || bookmark.url.toLowerCase().includes(urlTerm)) && (commentTerm === '' || bookmark.comment.toLowerCase().includes(commentTerm));
    });
