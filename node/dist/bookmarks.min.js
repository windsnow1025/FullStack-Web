...
axios__WEBPACK_IMPORTED_MODULE_1___default().get('/api/bookmarks-api/' + username).then(response => {
    ...
    if (isAdmin) {
      div.oncontextmenu = event => {
        ...
        if (newTitle && newUrl) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_1___default().put('/api/bookmarks/' + bookmark.id, {
            title: newTitle,
            url: newUrl
          }).then(() => {
