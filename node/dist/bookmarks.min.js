...
/* harmony import */ var _theme_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./theme.js */ "./public/js/theme.js");



// Theme

(0,_theme_js__WEBPACK_IMPORTED_MODULE_2__.initializeTheme)();
...
document.querySelector('#addBookmarkForm').addEventListener('submit', function (event) {
  ...
  addBookmark(bookmark).then(() => {
    form.reset();
    // reload bookmarks
    axios__WEBPACK_IMPORTED_MODULE_1___default().get('/api/bookmarks-api/').then(res => displayBookmarks(res.data));
  });
});
})();
