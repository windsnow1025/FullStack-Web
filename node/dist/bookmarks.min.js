...
class Bookmarks {
  ...
  async fetchBookmarks() {
    let res = await axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/bookmark-api/');
  ...
  async addBookmark() {
    ...
    await axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/bookmark-api/', bookmark);
  ...
  async editBookmark(id, editButton, firstTitleTd, secondTitleTd, urlTd, commentTd) {
    ...
    if (editButton.textContent === 'Edit') {
      ...
      await axios__WEBPACK_IMPORTED_MODULE_0___default().put(`/api/bookmark-api/${id}`, updatedBookmark);
  ...
  async deleteBookmark(id) {
    ...
    await axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"](`/api/bookmark-api/${id}`);
    // reload bookmarks
    let res = await axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/bookmark-api/');
    this.bookmarks = res.data;
