...
/* harmony import */ var _auth_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auth.js */ "./public/js/auth.js");
/* harmony import */ var _theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./theme */ "./public/js/theme.js");


// Account

(0,_auth_js__WEBPACK_IMPORTED_MODULE_1__.handleAuth)();
let username = (0,_auth_js__WEBPACK_IMPORTED_MODULE_1__.getUsername)();
let isAdmin = username == "windsnow1025@gmail.com";

// Theme

(0,_theme__WEBPACK_IMPORTED_MODULE_2__.initializeTheme)();
class Bookmarks {
  constructor() {
    this.bookmarks = [];
  }
    ...
    bookmarks.forEach(bookmark => {
      ...
      editButton.addEventListener('click', () => {
        ...
        if (editButton.textContent === 'Edit') {
          ...
          this.editBookmark(bookmark.id, updatedBookmark).then(() => {
            // reload bookmarks
            axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/bookmark-api/').then(res => this.displayBookmarks(res.data));
          });
        }
      });
      ...
      deleteButton.addEventListener('click', () => {
        ...
        this.deleteBookmark(bookmark.id).then(() => {
          // reload bookmarks
          axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/bookmark-api/').then(res => displayBookmarks(res.data));
        });
      });
  ...
  addBookmark(bookmark) {
    return axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/bookmark-api/', bookmark);
  }
  editBookmark(id, bookmark) {
    return axios__WEBPACK_IMPORTED_MODULE_0___default().put(`/api/bookmark-api/${id}`, bookmark);
  }
  deleteBookmark(id) {
    return axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"](`/api/bookmark-api/${id}`);
  }
}
...
document.querySelector('#addButton').addEventListener('click', function () {
  ...
  bookmarks.addBookmark(bookmark).then(() => {
    ...
    // Reload bookmarks
    axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/bookmark-api/').then(res => bookmarks.displayBookmarks(res.data));
  }).catch(error => {
...
window.onload = function () {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/bookmark-api/').then(res => {
    // Display bookmarks
...
searchInput.addEventListener('input', function () {
  ...
  const filteredBookmarks = bookmarks.bookmarks.filter(bookmark => {
    ...
    return bookmark.first_title.toLowerCase().includes(searchTerm) || bookmark.second_title.toLowerCase().includes(searchTerm) || bookmark.url.toLowerCase().includes(searchTerm) || bookmark.comment.toLowerCase().includes(searchTerm);
  });
