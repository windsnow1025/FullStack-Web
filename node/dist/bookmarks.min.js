...
/*!********************************!*\
  ...
  \********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./auth.js */ "./public/js/auth.js");
...
let username = (0,_auth__WEBPACK_IMPORTED_MODULE_0__.getUsername)();
    ...
    editButton.addEventListener('click', () => {
      ...
      if (editButton.textContent === 'Edit') {
        ...
        editBookmark(bookmark.id, updatedBookmark).then(() => {
          // reload bookmarks
          axios__WEBPACK_IMPORTED_MODULE_1___default().get('/api/bookmark-api/').then(res => displayBookmarks(res.data));
        });
      }
    });
...
function addBookmark(bookmark) {
  return axios__WEBPACK_IMPORTED_MODULE_1___default().post('/api/bookmark-api/', bookmark);
}
function editBookmark(id, bookmark) {
  return axios__WEBPACK_IMPORTED_MODULE_1___default().put(`/api/bookmark-api/${id}`, bookmark);
}
function deleteBookmark(id) {
  return axios__WEBPACK_IMPORTED_MODULE_1___default()["delete"](`/api/bookmark-api/${id}`);
}
...
window.onload = function () {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1___default().get('/api/bookmark-api/').then(res => {
    // Display bookmarks
